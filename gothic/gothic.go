...
See https://github.com/BryceWayne/goth/blob/master/examples/main.go to see this in action.
*/
package gothic
...
See https://github.com/BryceWayne/goth/examples/main.go to see this in action.
*/
